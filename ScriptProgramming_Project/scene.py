...
class Scene:
    def __init__(self):
        ...
        self.playerTankBody.AddComponent(Sprite(sprite=SpriteManager().GetInstance().GetSprite("body")))
        ...
        self.playerTankTurret.AddComponent(Sprite(sprite=SpriteManager().GetInstance().GetSprite("turret")))
